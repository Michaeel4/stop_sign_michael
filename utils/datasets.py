...
def set_cropping(crop):
    global cropping
    cropping = crop

def set_cropping_values(crop_values):
    global cropping_x1
    global cropping_y1
    global cropping_x2
    global cropping_y2
    cropping_x1 = crop_values[0]
    cropping_y1 = crop_values[1]
    cropping_x2 = crop_values[2]
    cropping_y2 = crop_values[3]
...
class LoadImages:  # for inference
    ...
    def __next__(self):
        ...
        global cropping_y2
        if cropping:
            img0 = img0[cropping_x1:cropping_y1,cropping_x2:cropping_y2]
